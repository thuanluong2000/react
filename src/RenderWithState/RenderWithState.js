...
export default class RenderWithState extends Component {
    ...
    */
    ...
    /*
        this.state: là thuộc tính có sẵn của react component. Dùng để chứa các giá trị thay đổi trên giao diện khi người dùng thao tác(click,gõ phím,...) 
    */
    state = {
        login: false
    }
